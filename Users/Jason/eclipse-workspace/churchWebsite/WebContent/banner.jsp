                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                      ...
                      <tr>
                        <td>
                          &nbsp;<span class="tLeft">
                          <input name="Submit31922" type="submit" onclick="MM_goToURL('parent','banner_2.htm');return document.MM_returnValue" value="新增">
                          </span>
                          <form action="bannerController" method="post">
	                      		<c:forEach var="bannerList" items="${bannerList}">
								<tr>
									<td><c:out value="${bannerList.name}"/></td>
									<td><c:out value="${bannerList.start_time}"/></td>
									<td><c:out value="${bannerList.end_time}"/></td>
								</c:forEach>
                          </form>
                          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="disc_table">
                            ...
                            <tr>
                              ...
                              <td>2010-01-02</td>
                              <td>2010-06-30</td>
                              <td><a href="banner_2.htm">編輯</a> I 刪除</td>
                              </tr>
                            <tr class="altrow">
                              <td>2</td>
                              <td>&nbsp;</td>
